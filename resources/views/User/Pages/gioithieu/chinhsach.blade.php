    ...
    <div class="breadcrumb-section breadcrumb-bg-color--golden">
        <div class="breadcrumb-wrapper">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h3 class="breadcrumb-title">Chính sách sử dụng dịch vụ</h3>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container mw-50 mt-10 mb-10 p-3 align-items-center align-content-center">
        <div class="large-12 col">
            <div class="col-inner">
                ...
                <p style="text-align: justify;">Nếu bạn muốn có bản sao dữ liệu cá nhân mà chúng tôi lưu giữ về bạn, vui lòng gửi email cho chúng tôi theo địa chỉ cskh@nero.com.vn</p>
